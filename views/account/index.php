                                ...
                                <div class="msg-list">
                                    ...
                                    <div class="msg-unit msg-unread">
                                        <div class="msg-content">
                                            ...
                                            <figure>
                                                <img src="/template/assets/img/users/1.jpg" alt="">
                                            </figure>
                                            <header>
                                                <strong>Jesscia Brown </strong> | Iphone 6 Plus Factory Unlocked 16GB
                                            </header>
                                            <div class="msg-body">
                                                <p>Hey! Do you want to sell your phone at $220? Write me back as
                                                    soon</p>
                                        ...
                                        <div class="msg-actions">
                                            <ul>
                                                ...
                                                <li><a class="tc12-hover" href="#"><i class="adicon-recyclebin"></i></a>
                                                </li>
                                                <li>
                                                    <div class="custom-check">
                                    ...
                                    <div class="msg-unit msg-unread">
                                        <div class="msg-content">
                                            <a class="msg-open" href="#">open message</a>
                                            <figure>
                                                <img src="/template/assets/img/users/2.jpg" alt="">
                                            </figure>
                                            <header>
                                                <strong>Jesscia Brown </strong> | Iphone 6 Plus Factory Unlocked 16GB
                                            </header>
                                    ...
                                    <div class="msg-unit">
                                        <div class="msg-content">
                                            <a class="msg-open" href="#">open message</a>
                                            <figure>
                                                <img src="/template/assets/img/users/3.jpg" alt="">
                                            </figure>
                                            <header>
                                                <strong>Jesscia Brown </strong> | Iphone 6 Plus Factory Unlocked 16GB
                                            </header>
                                    ...
                                    <div class="msg-unit">
                                        <div class="msg-content">
                                            <a class="msg-open" href="#">open message</a>
                                            <figure>
                                                <img src="/template/assets/img/users/4.jpg" alt="">
                                            </figure>
                                            <header>
                                                <strong>Jesscia Brown </strong> | Iphone 6 Plus Factory Unlocked 16GB
                                            </header>
                                    ...
                                    <div class="msg-unit">
                                        <div class="msg-content">
                                            <a class="msg-open" href="#">open message</a>
                                            <figure>
                                                <img src="/template/assets/img/users/5.jpg" alt="">
                                            </figure>
                                            <header>
                                                <strong>Jesscia Brown </strong> | Iphone 6 Plus Factory Unlocked 16GB
                                            </header>
                            ...
                            <div class="inner">
                                <div class="text-widget">
                                    <div class="inner">
                                        ...
                                        <p>
                                            Ad Alerts are email updates about latest ads that match your need or
                                            criteria. They can really save your time! Just tell us what you're looking
                                            for and we'll email you when matching ads are posted.
                                        </p>
                                        <h5>How Do I Set An Ad Alert?</h5>

                                        <p>We have made it very simple for you as there are two simple ways you can
                                            create an ad alert. Read the options below to create an ad alert now.</p>

                                        <ul class="caret-right-list">
                                            <li>Fill in the form below to create an ad alert.</li>
                                            <li>While searching, simply click the "Create Email Alert" link on the
                                                search results page.
                                            </li>
                                        </ul>
                                ...
                                <div class="email-alerts-2">
                                    ...
                                    <form>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-md-6">
                                                <button class="btn block-element btn-yellow" type="submit">Create
                                                    alert
                                                </button>
                                            </div>
                                                ...
                                                <form action="/">
                                                    ...
                                                    <div class="field-block">
                                                        <div class="radio-dropdown wide">
                                                            ...
                                                            <ul>
                                                                <li class="custom-radio">
                                                                    <input type="radio" id="create022"
                                                                           name="item-brand-name">
                                                                    <label for="create022">Bradford</label>
                                                                </li>
                                                                <li class="custom-radio">
                                                                    <input type="radio" id="create023"
                                                                           name="item-brand-name">
                                                                    <label for="create023">Cambridge</label>
                                                                </li>
                                                                <li class="custom-radio">
                                                                    <input type="radio" id="create024"
                                                                           name="item-brand-name">
                                                                    <label for="create024">Chester</label>
                                                                </li>
                                                                <li class="custom-radio">
                                                                    <input type="radio" id="create025"
                                                                           name="item-brand-name">
                                                                    <label for="create025">Durham</label>
                                                                </li>
                                                                <li class="custom-radio">
                                                                    <input type="radio" id="create026"
                                                                           name="item-brand-name">
