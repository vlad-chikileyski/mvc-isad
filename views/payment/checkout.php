...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/template/assets/css/base.css"/>
    <link rel="stylesheet" type="text/css" href="/template/assets/css/example1.css"/>
...
<div class="web-app">
            ...
            <div class="checkout-area row">
                <div class="col-xs-12 col-md-8">
                    ...
                    <div class="panel-block">
                        <div class="inner" style="padding: 0px 0px 10px 0px;background: none;">
                            <div class="row09x">
                                <main>
                                    <section class="container-lg">
                                        ...
                                        <div class="cell example example1">
                                            ...
                                            <div class="success" style="box-sizing: border-box;">
                                                <div class="icon">
    ...
    <script src="/template/assets/js/example1.js"></script>
