        ...
        <!-- sidebar menu start-->            <div class="leftside-navigation">
            ...
            <li class="sub-menu">
                ...
                <ul class="sub">
                    ...
                    <li><a href="hotkey.php">Ключевые слова</a></li>
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    <td>1</td>
                                    <td><a href="update-category.php" style="color: blue">Услуги</a></td>
                                    <td>0</td>
                                    <td>[<a href="update-category.php" style="color: red">Изменить</a>]</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
