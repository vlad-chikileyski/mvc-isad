        ...
        <!-- sidebar menu start-->            <div class="leftside-navigation">
            ...
            <li class="sub-menu">
                ...
                <ul class="sub">
                    ...
                    <li class="active"><a href="advanced_form.html">Товары</a></li>
                </ul>
            </li>
            <li class="sub-menu">
                <a href="javascript:;">
                ...
                <ul class="sub">
                    ...
                    <li><a href="form_validation.html">Поставщики</a></li>
                </ul>
            </li>
             <li class="sub-menu">
                <a href="javascript:;">
        ...
        <div class="row">
            <div class="col-sm-12">
                <section class="panel">
                    ...
                    Товары<span class="tools pull-right">
                         </span>
                    </header>
                        ...
                        <div class="adv-table editable-table ">
                            <div class="clearfix">
                                ...
                                <div class="btn-group pull-right">
                                    <button class="btn btn-default dropdown-toggle" data-toggle="dropdown">Отчёты<i class="fa fa-angle-down"></i>
                                    </button>
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="#">Распечатать</a></li>
                                        <li><a href="#">Сохранить в PDF</a></li>
                                        <li><a href="#">Экспорт в Excel</a></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                ...
                                <tr class="">
                                    <td></td>
                                    <td><img src="http://static.nix.ru/autocatalog/coolers_SuperMicro/170408_2254_draft_large.jpg" style="padding: 1px; border: 1px solid #DDDDDD;max-width: 100px;"></td>
                                    <td>IDE Cable(3connectors)</td>
                                    <td>Переходники, разветвители</td>
                                    <td>1485</td>
                                    <td class="center">5.2900</td>
                                   <td class="center">Активен</td>
