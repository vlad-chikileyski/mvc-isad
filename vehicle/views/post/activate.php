            ...
            <div class="inner">
                <div class="pt-100 pb-100">
                    ...
                    <div class="heading text-center">
                        <h2>Thank you for adding ads on the website Adtoday.co.uk</h2>
                    </div>
                    <header class="page-header text-center">
                        <p style="font-size: 20px;">Your ad is <strong>not yet visible</strong> on the website
                            <br>The ad will be active when you click on the link in the email<br>
                            <strong>Check your e-mail and activate ad</strong>!
